...
func main() {
	...
	if gormDB != nil {
		...
		chatUserSettingsRepository := repository.NewChatUserSettingsRepository(gormDB)
		chatValidation := validations.NewChatValidation()
		chatService := services.NewChatService(chatRepository, friendRepository, inviteRepository, mediaRepository, postRepository, userSettingsRepository, profileRepository, chatUserSettingsRepository, notificationService, chatValidation)
		chatHub := ws.NewHub()
		go chatHub.Run()
		...
		groupChatService := services.NewGroupChatService(groupChatRepository, chatRepository, chatService, notificationService, validations.NewGroupChatValidation(), chatUserSettingsRepository)
